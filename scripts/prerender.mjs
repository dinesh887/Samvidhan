...
function metadata(path) {
  ...
  const title = article ? `${article.articleNumber} — ${article.title.en} | Samvidhan` : config.title.en
  const description = article ? article.simpleExplanation.en : config.description.en
