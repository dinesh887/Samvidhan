...
function SchemaJsonLd() {
  ...
  useEffect(() => {
    ...
    const breadcrumbName = pathname === "/faq" ? language === "mr" ? "वारंवार विचारले जाणारे प्रश्न" : "FAQ" : pageTitle;
    ...
    const graph = [
      ...
      },
      {
        ...
        inLanguage: language,
        potentialAction: { "@type": "SearchAction", target: `${SITE_URL}/articles?q={search_term_string}`, "query-input": "required name=search_term_string" }
      },
      {
        "@type": "WebPage",
        "@id": pageId,
        ...
        ...pathname === "/faq" ? { mainEntity: { "@id": faqPageId } } : {}
      },
      {
        "@type": "BreadcrumbList",
        "@id": breadcrumbId,
        itemListElement: [
          { "@type": "ListItem", position: 1, name: language === "mr" ? "मुख्यपृष्ठ" : "Home", item: SITE_URL },
    ...
    if (article) {
      ...
      if (article.lastVerified) articleSchema.dateModified = article.lastVerified;
    ...
    if (pathname === "/faq") {
      graph.push({
        ...
        mainEntity: faqs.map((faq) => ({
          ...
          acceptedAnswer: { "@type": "Answer", text: pick(faq.answer) }
        }))
      });
    }
    upsertSchema(graph);
